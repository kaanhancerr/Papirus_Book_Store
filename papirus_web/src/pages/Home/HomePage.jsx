...
const HomePage = () => {
    ...
    const columns = [
        ...
        },
        {
            accessorKey: 'card',
            header: 'Sepete Ekle',
            cell: (info) => <Button sx={{ backgroundColor: '#eadec6', color: 'black' }} variant='contained' onClick={() => handleAddList(info.row.original)}>Ekle</Button> //sadece tiklanan buton detayini alir.
